...
- (void)cricle {
    ...
    //设置画笔路径
    UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(self.frame.size.width/2.0, self.frame.size.height/2.0) radius:self.frame.size.width/2.0 - 20 startAngle:-M_PI_2+M_PI*2 endAngle:-M_PI_2 clockwise:NO];

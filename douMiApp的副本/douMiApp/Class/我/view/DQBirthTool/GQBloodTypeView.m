...
@interface GQBloodTypeView ()<DQCanCerEnsureViewDelegate>
...
@end
@implementation GQBloodTypeView
...
- (void)ClickEnsureDelegateFunction{
    ...
    [self CloseAnimationFunction];
    if ([self.delegate respondsToSelector:@selector(clickGQBloodTypeStr:)]) {
        
        [self.delegate clickGQBloodTypeStr:self.constellationStr];
    }
}

...
@property (nonatomic, copy) NSString *LGQType;
@property (nonatomic, strong) NSArray <Hashmaplist *>*dataSelfArr;
@property (nonatomic, strong) Hashmaplist *mode;

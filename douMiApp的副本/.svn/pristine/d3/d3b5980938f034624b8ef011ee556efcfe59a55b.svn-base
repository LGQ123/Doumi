...
@interface mpViewController ()<ZFPlayerDelegate>
@property (strong, nonatomic) ZFPlayerView *playerView;
@property (weak, nonatomic) IBOutlet UIView *playMyView;
...
//        _playerModel.title = self.titleStr;
        _playerModel.videoURL = [NSURL URLWithString:self.mvStr];
        _playerModel.placeholderImage = [UIImage imageNamed:@"loading_bgView1"];
        _playerModel.fatherView = self.playMyView;
    }
    return _playerModel;
}

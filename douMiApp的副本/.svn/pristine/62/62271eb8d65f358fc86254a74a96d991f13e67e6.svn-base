...
- (void)createCellView {
    ...
    [self.titleLable whc_LeftSpace:10];
    [self.titleLable whc_TopSpace:15];
    [self.titleLable whc_Width:75];
    ...
    [self.contentLable whc_TopSpace:15];
    [self.contentLable whc_RightSpace:10];
    [self.contentLable whc_Height:13];
}
